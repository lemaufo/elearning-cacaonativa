...
<div class="certificate">
    ...
    <div class="body">
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($certificate->course->area): ?>
            <p class="meta">Área: <?php echo e($certificate->course->area); ?></p>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

        <p class="meta">Calificación obtenida: <strong><?php echo e($certificate->score); ?>%</strong></p>
        <p class="meta">Fecha de emisión: <?php echo e($certificate->issued_at->translatedFormat('d \d\e F \d\e Y')); ?></p>
    </div>
    ...
    <p class="uuid">ID: <?php echo e($certificate->uuid); ?></p>
</div>
</body>
